  ...
  return (
    <section id="home" className="relative overflow-hidden pt-28 sm:pt-32 lg:pt-36">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-b from-brand-soft/60 via-white to-white" />
        <div className="absolute -top-24 right-[-10%] h-[520px] w-[520px] rounded-full bg-brand/10 blur-3xl" />
        <div className="absolute top-40 left-[-15%] h-[420px] w-[420px] rounded-full bg-[#7FE3D0]/30 blur-3xl" />
        <div
          className="absolute inset-0 opacity-[0.4]"
          style={{
            backgroundImage:
              "radial-gradient(circle at 1px 1px, rgba(15,34,48,0.06) 1px, transparent 0)",
      ...
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-5 pb-16 sm:px-8 lg:grid-cols-[1.05fr_1fr] lg:gap-10 lg:px-10 lg:pb-24">
        ...
        <div className="flex flex-col items-start">
          <motion.span
            ...
            className="inline-flex items-center gap-2 rounded-full border border-brand/25 bg-white/80 px-4 py-2 text-[0.68rem] font-bold uppercase tracking-[0.18em] text-brand shadow-sm backdrop-blur"
          >
          ...
          <motion.h1
            ...
            className="mt-5 text-balance text-4xl font-extrabold leading-[1.05] tracking-tight text-navy sm:text-5xl lg:text-[3.6rem]"
          >
            A Cleaner Space.
            <br />
            <span className="relative inline-block">
              <span className="relative z-10 bg-gradient-to-r from-[#0A8F7C] to-[#15C3A5] bg-clip-text text-transparent">
        ...
        >
          ...
          <div className="absolute -right-6 -top-6 -z-10 h-32 w-32 rounded-full border-2 border-dashed border-brand/30" />
          <div className="absolute -bottom-8 -left-8 -z-10 h-40 w-40 rounded-full bg-brand-soft/60 blur-2xl" />

          <div className="relative overflow-hidden rounded-[2rem] shadow-[0_30px_80px_-30px_rgba(15,34,48,0.4)] ring-1 ring-navy/5">
          ...
          >
            <span className="grid size-10 place-items-center rounded-xl bg-gradient-to-br from-[#15C3A5] to-[#0A8F7C] text-white shadow-md">
