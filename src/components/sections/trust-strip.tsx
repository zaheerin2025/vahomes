          ...
          >
            {values.map((v, i) => (
              <StaggerItem key={v.title}>
                <div className="group relative flex h-full flex-col items-start gap-3 rounded-2xl border border-transparent p-4 transition-all hover:border-gold/20 hover:bg-gold-soft/40">
                  <span
                    className={
                      "grid size-12 place-items-center rounded-2xl text-white shadow-sm transition-all duration-300 " +
                      (i === 0
