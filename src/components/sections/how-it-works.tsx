...
export function HowItWorks() {
  ...
  const steps = [
    { number: "01", title: t("how.step1Title"), description: t("how.step1Desc"), icon: "ClipboardList" },
    { number: "02", title: t("how.step2Title"), description: t("how.step2Desc"), icon: "CalendarCheck" },
    { number: "03", title: t("how.step3Title"), description: t("how.step3Desc"), icon: "Sparkles" },
  ];

  return (
    <SectionShell id="how-it-works" className="bg-gradient-to-b from-gold-soft/30 to-white">
      <SectionHeading
